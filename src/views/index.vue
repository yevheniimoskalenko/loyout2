<template>
  <div class="container-fluid">
        ...
        <div class="menu">
          <div class="row">
            ...
            <div class="col">
              <ul class="menu__link">
                <li>
                  <router-link to="/" class="menu__active">home</router-link>
                </li>
                <li>
        ...
        <div class="touch">
          ...
          <div class="touch__form">
            <form>
              <div class="row">
                <div class="col">
                  <div class="form_group">
                    <input type="text" class="form-control bgc" placeholder="Your Name *" />
                  </div>
                </div>
                <div class="col">
                  <div class="form_group">
              ...
              <div class="form_group">
                <textarea class="form-control textr bgc" placeholder="Your Name *"></textarea>
              </div>
    ...
    <section class="footer d-flex justify-content-center align-items-center">
      <div class="container">
        <div class="footer__link">
          <router-link to="/">Facebook</router-link>
          <router-link to="/">Twitter</router-link>
          <router-link to="/">Google+</router-link>
          <router-link to="/">Linkedln</router-link>
          <router-link to="/">Behance</router-link>
          <router-link to="/">Dribbble</router-link>
          <router-link to="/">GitHab</router-link>
        </div>
      </div>
    </section>
  </div>
